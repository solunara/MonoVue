      ...
      <el-row style="margin: 20px 0">
        <el-col :span="12">
          <div class="phone" v-show="scene == LoginScene.Phone">
            ...
            <el-button type="primary" style="width: 100%" :disabled="isDisableLoginButton" @click="loginWithCode"
              >用户登陆</el-button
            >
            <div class="userlogin" @click="changeScene">
              ...
              >
                ...
                ></path>
                <path
                  d="M313.344 352.256m-36.864 0a36.864 36.864 0 1 0 73.728 0 36.864 36.864 0 1 0-73.728 0Z"
                  fill="#65DB79"
                  p-id="7345"
                ></path>
                <path
                  d="M497.664 352.256m-36.864 0a36.864 36.864 0 1 0 73.728 0 36.864 36.864 0 1 0-73.728 0Z"
                  fill="#65DB79"
                  p-id="7346"
                ></path>
                <path
                  d="M585.728 544.768m-32.768 0a32.768 32.768 0 1 0 65.536 0 32.768 32.768 0 1 0-65.536 0Z"
                  fill="#65DB79"
                  p-id="7347"
                ></path>
                <path
                  d="M741.376 544.768m-32.768 0a32.768 32.768 0 1 0 65.536 0 32.768 32.768 0 1 0-65.536 0Z"
                  fill="#65DB79"
                  p-id="7348"
                ></path>
              </svg>
          ...
          <div class="webchat" v-show="scene == LoginScene.WeChat">
            ...
            <div class="userlogin" @click="changeScene">
              ...
              >
                <path
                  d="M511.9 714.6m-35.3 0a35.3 35.3 0 1 0 70.6 0 35.3 35.3 0 1 0-70.6 0Z"
                  fill="#65DB79"
                  p-id="24720"
                ></path>
                <path
                  d="M644.4 265.8h-265c-11.8 0-21.5 9.1-21.5 20.2v345.8c0.8-0.1 1.5-0.2 2.3-0.2h302.7c1 0 2 0.2 3 0.3V286.1c0-11.2-9.7-20.3-21.5-20.3z"
                  fill="#65DB79"
                  p-id="24721"
                ></path>
                <path
                  d="M511.9 64.2c-247.2 0-447.7 200.4-447.7 447.7s200.4 447.7 447.7 447.7c247.2 0 447.7-200.4 447.7-447.7S759.1 64.2 511.9 64.2z m197 673.5c0 33.4-29 60.7-64.5 60.7h-265c-35.5 0-64.5-27.3-64.5-60.7V286.1c0-33.4 29-60.7 64.5-60.7h265c35.5 0 64.5 27.3 64.5 60.7v451.6z"
                  fill="#65DB79"
                  p-id="24722"
                ></path>
              </svg>
          ...
          <div class="right">
            <div class="righttop">
              <div class="item">
                ...
                >
                  <path
                    d="M661.46 430.56c3.44 0 6.86 0.08 10.27 0.2-21.68-99.27-123.99-174.43-246.96-174.43-138.74 0-251.21 95.68-251.21 213.71 0 68.96 38.4 130.28 97.99 169.35l-25.1 74.03 83.11-45.57c29.36 10.24 61.5 15.9 95.2 15.9 6.5 0 12.93-0.21 19.31-0.62-7.03-18.62-10.84-38.46-10.84-59.06 0.01-106.87 102.19-193.51 228.23-193.51z m-150-68.58c20.49 0 37.1 16.61 37.1 37.1 0 20.49-16.61 37.1-37.1 37.1s-37.1-16.61-37.1-37.1c0.01-20.49 16.62-37.1 37.1-37.1z m-172.58 74.2c-20.49 0-37.1-16.61-37.1-37.1 0-20.49 16.61-37.1 37.1-37.1 20.49 0 37.1 16.61 37.1 37.1 0 20.49-16.61 37.1-37.1 37.1z"
                    fill="#515151"
                    p-id="7712"
                  ></path>
                  <path
                    d="M873.56 624.08c0-99.32-94.96-179.84-212.1-179.84s-212.1 80.52-212.1 179.84 94.96 179.84 212.1 179.84c24.6 0 48.21-3.56 70.17-10.09l72.52 39.77-21.08-62.17c54.72-32.53 90.49-86.4 90.49-147.35zM595.2 598.27c-16.4 0-29.7-13.3-29.7-29.7s13.3-29.7 29.7-29.7 29.7 13.3 29.7 29.7-13.3 29.7-29.7 29.7z m138.18 0c-16.4 0-29.7-13.3-29.7-29.7s13.3-29.7 29.7-29.7 29.7 13.3 29.7 29.7-13.3 29.7-29.7 29.7z"
                    fill="#515151"
                    p-id="7713"
                  ></path>
                </svg>
              ...
              <div class="item">
                ...
                >
                  <path
                    d="M230.4 48.64a28.16 28.16 0 0 0-28.16 28.16v870.4a28.16 28.16 0 0 0 28.16 28.16h563.2a28.16 28.16 0 0 0 28.16-28.16V76.8a28.16 28.16 0 0 0-28.16-28.16H230.4z m0-46.08h563.2c41.00096 0 74.24 33.23904 74.24 74.24v870.4c0 41.00096-33.23904 74.24-74.24 74.24H230.4c-41.00096 0-74.24-33.23904-74.24-74.24V76.8C156.16 35.79904 189.39904 2.56 230.4 2.56zM512 901.12c-28.27776 0-51.2-22.92224-51.2-51.2s22.92224-51.2 51.2-51.2 51.2 22.92224 51.2 51.2-22.92224 51.2-51.2 51.2z"
                    fill="#000000"
                    p-id="10718"
                  ></path>
                </svg>
