<template>
  ...
  <el-card v-if="userInfo !== null" class="box-card">
    ...
    <!-- 未实名时展示 -->
    <el-form v-else ref="form" style="margin: 20px auto; width: 60%" label-width="80" :model="params" :rules="rules">
      ...
      <el-form-item label="上传证件">
        ...
        <el-dialog v-model="dialogVisible">
          <img w-full v-if="previewImage" style="width: 100%; height: 100%" :src="previewImage" alt="Preview Image" />
        </el-dialog>
      </el-form-item>
      <el-form-item>
