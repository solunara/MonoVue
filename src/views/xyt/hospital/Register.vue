    ...
    <div class="register">
        ...
        <div class="content">
            ...
            <div class="right">
                ...
                <div class="address">
                    具体位置: {{ hosDetail.hospitalDetail?.address }}
                </div>
            </div>
        </div>
        <!-- 医院科室数据 -->
         <div class="department">
            ...
            <div class="leftNav">
                <ul>
                    <li @click="changeIndex(index)" :class="{active:currentIndex==index}" v-for="(dpt,index) in hosDetail.departmentList" :key="dpt.uid">{{ dpt.name }}</li>
                </ul>
            </div>
            <!-- 二级科室列表 -->
            <div class="rightNav">
